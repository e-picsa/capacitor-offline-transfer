# Capacitor Offline Transfer Example

This is a demo application for the `@picsa/capacitor-offline-transfer` plugin, showing how to implement peer-to-peer connectivity between iOS and Android devices.
